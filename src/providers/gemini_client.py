...
class GeminiClient(LLMProvider):
    ...
    **Strict Output:** Your response must **strictly adhere** to the JSON Schema provided. Do not include the rubric, any prose, or Markdown tags (e.g., ```json) outside of the JSON object itself.
    **Mandatory Procedure:**
